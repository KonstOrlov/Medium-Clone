        ...
        <div class="col-md-6 offset-md-3 col-xs-12" >
          ...
          <form @submit.prevent="onSubmit" >
            <fieldset >
              ...
              <fieldset class="form-group" >
                <input type="email" class="form-control form-control-lg" v-model="form.email" placeholder="Email" >
              </fieldset >
              <fieldset class="form-group" >
...
import {getterTypes as authGetterTypes, actionTypes as authActionTypes} from "@/store/Modules/auth.js";
